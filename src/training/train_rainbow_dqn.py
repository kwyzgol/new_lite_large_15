...
def _save_model(agent: RainbowDqnAgent, e_name: str, steps: int) -> str:
...
def _evaluate(
    ...
    env: GameEnv,
    agent: RainbowDqnAgent,
    previous_agent: RainbowDqnAgent | None,
...
def train_rainbow_dqn(
    ...
    logger = TrainingLogger(
        ...
        settings=settings,
        algo_name=AlgoName.RAINBOW_DQN,
        algo_type=AlgoType.Q_VALUE,
    )

    previous_agent: RainbowDqnAgent | None = None
