...
class GlobalSettings:
    ...
    # NEW | Modyfikacja w celu spróbowania poprawienia wyników
    base_immovable: bool = False
    ...
    advanced_model_chance: float = 0.5

    # NEW | Modyfikacja w celu spróbowania poprawienia wyników
    reward_closer_distance: float = 0.0
    penalty_greater_distance: float = -0.0
